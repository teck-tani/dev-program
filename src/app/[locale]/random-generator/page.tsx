    ...
    const faqData = locale === 'ko' ? [
        {
            ...
            answer: "랜덤 숫자(정수/소수), 랜덤 이름(한국어/영어), 랜덤 색상(HEX/RGB/HSL), 주사위(D4~D20), 동전 뒤집기 등 5가지 랜덤 생성 기능을 제공합니다."
        },
        {
        ...
        },
        {
            ...
            answer: "한국의 대표적인 성 20개(김, 이, 박, 최 등)와 이름에 자주 사용되는 음절 20개를 조합하여 자연스러운 한국 이름을 랜덤으로 생성합니다. 1~2음절 이름이 무작위로 만들어집니다."
        },
        {
    ...
    ] : [
        {
            ...
            answer: "It provides 5 random generation features: random numbers (integer/decimal), random names (Korean/English), random colors (HEX/RGB/HSL), dice rolling (D4-D20), and coin flipping."
        },
        {
        ...
        },
        {
            ...
            answer: "Korean names are generated by combining 20 common Korean surnames (Kim, Lee, Park, Choi, etc.) with 20 frequently used name syllables to create natural-sounding Korean names with 1-2 syllable given names."
        },
        {
        ...
        "step": isKo ? [
            {
                "@type": "HowToStep",
                "name": "모드 선택",
                "text": "상단 탭에서 원하는 랜덤 생성 모드를 선택합니다: 숫자, 이름, 색상, 주사위, 동전."
            },
            {
                "@type": "HowToStep",
                "name": "옵션 설정",
        ...
        ] : [
            {
                "@type": "HowToStep",
                "name": "Select Mode",
                "text": "Choose a random generation mode from the tabs at the top: Number, Name, Color, Dice, or Coin."
            },
            {
                "@type": "HowToStep",
...
function generateWebAppSchema(locale: string) {
    ...
    return {
        ...
        "featureList": isKo
            ? [
                "랜덤 숫자 생성 (정수/소수, 범위 지정, 다량 생성)",
                "랜덤 이름 생성 (한국어/영어)",
                "랜덤 색상 생성 (HEX/RGB/HSL, 색상 미리보기)",
                "주사위 굴리기 (D4/D6/D8/D10/D12/D20, 최대 10개)",
                "동전 뒤집기 (앞면/뒷면, 히스토리 기록)"
            ]
            : [
                "Random number generation (integer/decimal, custom range, bulk)",
                "Random name generation (Korean/English)",
                "Random color generation (HEX/RGB/HSL, color preview)",
                "Dice rolling (D4/D6/D8/D10/D12/D20, up to 10 dice)",
