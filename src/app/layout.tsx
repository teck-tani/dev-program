...
export const metadata: Metadata = {
    title: "무료 웹 도구 모음 | 생활에 편리한 계산기, 시계, 이모지 | Tani DevTool",
    description: "일상생활과 업무에 필요한 다양한 무료 웹 도구 모음. 계산기, 시계, 이모지 등 필요한 도구를 한 곳에서 사용하세요. 모바일에서도 편리하게 이용 가능합니다.",
    keywords: "웹 도구, 무료 도구, 온라인 계산기, 대한민국 시계, 이모지 모음, 실용적인 웹 도구, 생활 도구, 개발자 도구, 온라인 유틸리티",
    openGraph: {
        type: "website",
        url: "https://tani-devtool.netlify.app/",
        title: "무료 웹 도구 모음 | Tani DevTool",
        description: "일상생활과 업무에 필요한 다양한 무료 웹 도구 모음. 계산기, 시계, 이모지 등 필요한 도구를 한 곳에서 사용하세요.",
